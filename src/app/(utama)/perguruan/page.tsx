      ...
      <section className="flex flex-col gap-3">
        ...
        <Kartu className="flex flex-col gap-3 p-5">
          <p className="text-[13px] leading-relaxed text-paper-dim">
            Pilih beberapa anggota sekaligus untuk didaftarkan ke Palembang Open
            Silat Fest 2026. Data profil masing-masing terisi otomatis; pengurus
            hanya memilih kategori lomba.
          </p>
          <button
            type="button"
          ...
          <CatatanDemo>
            Jalur ini juga yang dipakai untuk anggota yang tidak punya ponsel
            sendiri. Persetujuan wali tetap direkam terpisah dan tidak bisa
            diwakilkan pengurus.
          </CatatanDemo>
        </Kartu>
      </section>
            ...
            >
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-0.5">
                ...
                <p className="font-mono text-[11px] text-muted">
                  {a.umur} th · {namaKecamatan(a.kecamatanId)} · {a.medali.emas}
                  E{""}
