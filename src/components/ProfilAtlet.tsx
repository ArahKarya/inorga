...
import { TREN_ATLET, atletById, inisial } from "@/data/atlet";
import { namaKecamatan } from "@/data/wilayah";
import { namaPerguruan } from "@/data/perguruan";
import { ARENA, EVENTS, eventById, labelKategori } from "@/data/event";
import { ASPEK_INTI, hasilAtlet, riwayatAtlet } from "@/data/penilaian";
    ...
    <main className="mx-auto flex max-w-3xl flex-col gap-10 px-4 py-8 sm:px-6">
      ...
      <section className="flex flex-col gap-5">
        ...
        {tren.length > (TREN_ATLET[atletId]?.length ?? 0) ? (
          <CatatanDemo>
            Titik terakhir berasal dari nilai juri Piala Walikota 2026 yang baru
            saja dikunci — rapor bertambah begitu dewan juri selesai menilai.
          </CatatanDemo>
        ) : null}
      ...
      <section className="flex flex-col gap-5">
        ...
        <CatatanDemo>
          ...
          klik salah satu untuk mengeceknya, tanpa menghubungi penyelenggara.
        </CatatanDemo>
      </section>
    </main>
  );
